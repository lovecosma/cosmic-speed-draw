...
test.describe('authentication', () => {
  ...
  test('sign up issues persistent auth cookies and survives reload', async ({ page }, testInfo) => {
  ...
  test('sign in issues persistent auth cookies and survives reload', async ({ page, request }, testInfo) => {
    const baseURL = testInfo.project.use.baseURL
  ...
  test('real users are redirected away from guest-only routes', async ({ page }) => {
  ...
  test('sign in shows an error for invalid credentials and leaves the user signed out', async ({ page, request }) => {
  ...
  test('sign up shows validation errors for duplicate email and does not navigate away', async ({ page, request }) => {
